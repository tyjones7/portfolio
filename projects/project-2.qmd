...
<div class="d-flex justify-content-center gap-3 my-4 flex-wrap">
  <a class="btn btn-primary d-inline-flex align-items-center"
     href="https://ai-scheduling-assistant-jade.vercel.app"
...
<div class="row g-3 my-2">
  ...
  <div class="col-12">
    <figure class="figure w-100">
      <img src="../images/campusai-dashboard.png"
           ...
           alt="CampusAI dashboard showing assignment timeline and AI study plan sidebar"
           onerror="this.closest('figure').style.display='none'">
      <figcaption class="figure-caption text-center">
        Main dashboard — unified assignment timeline (left) with AI priority plan and chat sidebar (right)
      </figcaption>
    </figure>
  </div>
  ...
  <div class="col-md-6">
    <figure class="figure w-100">
      <img src="../images/campusai-onboarding.png"
           class="figure-img img-fluid rounded shadow-sm w-100"
           alt="CampusAI onboarding flow"
           onerror="this.closest('figure').style.display='none'">
      <figcaption class="figure-caption text-center">
        Onboarding — students connect Canvas and Learning Suite in under 5 minutes
      </figcaption>
    </figure>
  </div>
  ...
  <div class="col-md-6">
    <figure class="figure w-100">
      <img src="../images/campusai-ai-plan.png"
           class="figure-img img-fluid rounded shadow-sm w-100"
           alt="CampusAI AI-generated study plan"
           onerror="this.closest('figure').style.display='none'">
      <figcaption class="figure-caption text-center">
        AI study plan — priority scores, estimated time, and suggested start dates
      </figcaption>
    </figure>
  </div>
  ...
  <div class="col-md-6">
    <figure class="figure w-100">
      <img src="../images/campusai-chat.png"
           class="figure-img img-fluid rounded shadow-sm w-100"
           alt="CampusAI AI chat"
           onerror="this.closest('figure').style.display='none'">
      <figcaption class="figure-caption text-center">
        AI chat — streaming responses for mid-week re-prioritization
      </figcaption>
    </figure>
  </div>
  ...
  <div class="col-md-6">
    <figure class="figure w-100">
      <img src="../images/campusai-settings.png"
           class="figure-img img-fluid rounded shadow-sm w-100"
           alt="CampusAI settings page"
           onerror="this.closest('figure').style.display='none'">
      <figcaption class="figure-caption text-center">
        Settings — manage iCal feeds, study preferences, and weekly busy blocks
      </figcaption>
    </figure>
  </div>
